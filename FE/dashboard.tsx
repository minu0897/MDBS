...
const SERVER_API_BASE = process.env.NEXT_PUBLIC_SERVER_API_URL || "http://localhost:5000";


const fetcher = () =>
  fetch(`${SERVER_API_BASE}/system/docker/stats`).then((r) => {
...
const rdgStatsFetcher = () =>
  fetch(`${SERVER_API_BASE}/rdg/status`).then((r) => {
